...
#include <Vendor/detectObject.hpp>       // Easily detect faces or eyes (using LBP or Haar Cascades).
#include <Vendor/preprocessFace.hpp>     // Easily preprocess face images, for face recognition.
...
void vendor::equalizeLeftAndRightHalves(Mat &faceImg)
{
...
Mat vendor::getPreprocessedFace(Mat &srcImg, int desiredFaceWidth, CascadeClassifier &faceCascade, CascadeClassifier &eyeCascade1, CascadeClassifier &eyeCascade2, bool doLeftAndRightSeparately, Rect *storeFaceRect, Point *storeLeftEye, Point *storeRightEye, Rect *searchedLeftEye, Rect *searchedRightEye)
{
    // Use square faces.
